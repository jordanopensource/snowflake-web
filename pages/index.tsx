        ...
        <div className={grid.gridTwelve}>
          ...
          <div className="p-10  md:p-0 text-right w-full md:col-start-13 md:col-end-1 md:mr-0 md:row-start-2 lg:col-end-4 lg:col-start-1 lg:row-start-1">
            <p className="fontSize-5xl">
              يمكنك مساعدة الأشخاص على تجاوز الرقابة من خلال تمكين وكيل سنوفليك
              على يمينك. بمجرد أن تتحول أيقونة ندفة الثلج إلى اللون الأخضر، فهذا
              يعني أن المستخدم في بلد خاضع للرقابة يتصل من خلال وكيلك للوصول إلى
              الإنترنت دون قيود.
            </p>
            <br></br>

            <p>
              هذا المشروع مستضاف من قبل{' '}
              <Link className="underline" href="https://josa.ngo/">
                جوسا
              </Link>{' '}
              عن طريق{' '}
              <Link className="underline" href="https://www.torproject.org/">
                مشروع تور
              </Link>
            </p>
          </div>
